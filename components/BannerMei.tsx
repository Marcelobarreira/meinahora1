...
export default function BannerMEI() {
  ...
  return (
    <section
  className="w-full min-h-[70vh] sm:min-h-[80vh] lg:min-h-[50vh] flex items-center justify-center px-4 sm:px-6 md:px-8 bg-cover bg-center relative"
...
>
  ...
  <div className="max-w-4xl text-center text-white relative z-10">
    ...
    <button
      ...
      className="mt-6 px-6 py-3 bg-blue-600 text-white font-bold text-lg rounded-2xl shadow-md hover:bg-blue-700 transition w-full max-w-xs sm:w-auto"
    >
      Abrir meu MEI agora
    </button>
  </div>
